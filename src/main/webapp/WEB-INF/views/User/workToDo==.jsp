...
<body>
	<!-- Modal Animation -->
	<div id="modalAnim" class="modal fade">
														...
														<tbody>
															<c:forEach items="${modelNotStartedList}" var="model">
																<tr>
																	...
																	<td><a class="confirmWork" href="javascript:;">确认作业</a></td>
																</tr>
															</c:forEach>
														</tbody>
													</table>
														...
														<tbody>
															<c:forEach items="${modelConfirmedList}" var="model">
																<tr>
																	...
																	<td><a class="finishWork" href="javascript:;">更改状态</a></td>
																</tr>
															</c:forEach>
														</tbody>
													</table>
											...
											if (status == 0) {
												...
												tableEdit
														.fnAddData([
																...
																msg.checkModel.zxr_qrsj,
																"<td><a class='modal-with-zoom-anim'href='#modalAnim'>更改状态</a></td>" ]);
											} else if (status == 1) {
												...
												.fnAddData([
														...
														"<td><a class='modal-with-zoom-anim'href='#modalAnim'>查看</a></td>" ]);
											}
										},
										error : function(jqXHR, textStatus,
												errorThrown) {
