								...
								<div class="bk-padding-left-20 bk-padding-right-20">
									<div class="form-group">
										...
										<div class="input-group input-group-icon">
											<input name="yhdm" type="text" class="form-control bk-radius"
												id="username" placeholder="用户名" /> <span
									...
									<div class="form-group">
										<label>密码</label>
										<div class="input-group input-group-icon">
											<input name="yhkl" type="password"
												class="form-control bk-radius" id="password"
